...
namespace Reader
{
    ...
    public class ReaderMethod
    {
       ...
       public byte[] m_btAryBuffer = new byte[4096];
        //记录未处理数据的有效长度
        public int m_nLenth = 0;
        ...
        public void RunReceiveDataCallback(byte[] btAryReceiveData)
        {
            try
            {
        ...
        public int SendMessage(byte btReadId, byte btCmd)
        {
        ...
        public int SendMessage(byte btReadId, byte btCmd, byte[] btAryData)
        {
